...
class KeyMapper:
    ...
    # ✨ NUOVO: Mappa inversa dalle azioni ai tasti standard
    ...
    # ✨ NUOVO METODO - Questo è il cuore della soluzione!
    ...
    # ✨ NUOVO: Event filter globale per tradurre automaticamente i tasti
...
class KeyRemapperDialog(QDialog):
    ...
    def _create_info_banner(self):
        ...
        # Reset button stile launcher
        reset_btn = QPushButton("🔄 Reset All")
        reset_btn.setFixedSize(self.scaling.scale(150), self.scaling.scale(50))
    ...
    def _create_footer(self):
        ...
        save_btn.setFixedSize(self.scaling.scale(220), self.scaling.scale(55))
