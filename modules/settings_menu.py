...
class SettingsMenu(QWidget):
    ...
    def _create_info_widget(self):
        ...
        version_label = QLabel("Version: 0.7.1")
    ...
    def _handle_toggle(self, key, value):
        ...
        if self.launcher:
            # ✅ CRITICAL: Aggiorna config PRIMA di tutto
            ...
            if key == 'show_clock':
                ...
                # ✅ NUOVO: Forza set_focused() su tutte le tile esistenti
    ...
    def _handle_restore(self):
        ...
        try:
            ...
            if self._show_confirm_dialog(
                ...
                # ✅ STEP 7: Ricostruisci carousel (CRITICO!)
    ...
    def _do_full_reset(self):
        ...
        # ✅ STEP 3: Reset COMPLETO (codice originale che funzionava)
        default_config = {
            'apps': [],
            'background': '',
            'steamgriddb_api_key': '',
        ...
        # ✅ CRITICAL: Rimuovi backup PRIMA di resettare apps
        if hasattr(self.launcher, '_all_apps_backup'):
            delattr(self.launcher, '_all_apps_backup')
        ...
        # ✅ STEP 4: Salva su disco (PRIMA di ricostruire UI)
        self.launcher.save_config()
        ...
        # ✅ STEP 6: Ricostruisci carousel (DOPO aver salvato config vuota)
        self.launcher.build_infinite_carousel()
    ...
    def _handle_network_settings(self):
        ...
        try:
            ...
            if system == "Windows":
                ...
                print("🌐 Network settings opened (Windows)")
                ...
                for cmd in network_managers:
                    try:
                        ...
                        print(f"🌐 Network settings opened (Linux - {cmd[0]})")
                        opened = True
                        break
