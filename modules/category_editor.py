...
class CategoryEditorDialog(QDialog):
    ...
    def _create_default_row(self):
        ...
        hint = QLabel("Use for uncategorized apps")
        hint.setStyleSheet(f"""
            QLabel {{
                color: rgba(255, 255, 255, 0.35);
                font-size: {self.scaling.scale_font(11)}px;
        ...
        self.default_checkbox.setFixedHeight(self.scaling.scale(45))
        self.default_checkbox.setStyleSheet(f"""
            QCheckBox::indicator {{
                width: {self.scaling.scale(24)}px;
                height: {self.scaling.scale(24)}px;
                border: 2px solid #555;
    ...
    def _save_category(self):
        ...
        # Se questa diventa default, rimuovi flag dalle altre
        if is_default:
    ...
    def _delete_category(self):
        ...
        if reply == QMessageBox.StandardButton.Yes:
            ...
            print(f"🗑️ Category deleted: {category['name']}")
