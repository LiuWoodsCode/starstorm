...
# Import dei moduli refactorizzati (FASE 1)
...
class TVLauncher(QMainWindow):
    def __init__(self):
        ...
        #Aggiungi scorciatoia rapida (tasto C)
    ...
    def save_config(self):
        ...
        # FIX: Aggiungi config BackgroundManager in modo sicuro
        if hasattr(self, 'background_manager') and self.background_manager is not None:
            # Aggiungi la configurazione del BackgroundManager
